...
namespace Compiler.SemanticAnalysis
{
    ...
    public class DeclarationIdentifier
    {
        ...
        //Carries out identification on for command
        private void PerformIdentificationOnForCommand(ForCommandNode forCommandNode)
        {
            PerformIdentification(forCommandNode.command1);
            PerformIdentification(forCommandNode.command2);
            PerformIdentification(forCommandNode.command3);
            PerformIdentification(forCommandNode.expressionNode);
        }


        //Carries out identification on forever command
        private void PerfromIdentificationOnForeverCommand(ForeverCommandNode foreverCommandNode)
        {
            PerformIdentification(foreverCommandNode.commandNode);
            PerformIdentification(foreverCommandNode.expression);
        }
